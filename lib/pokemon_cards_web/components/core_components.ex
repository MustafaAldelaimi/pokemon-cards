defmodule PokemonCardsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PokemonCardsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PokemonCardsWeb.Gettext, "errors", msg, opts)
    end
  end
