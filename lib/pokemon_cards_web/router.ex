defmodule PokemonCardsWeb.Router do
  use PokemonCardsWeb, :router
  ...
  # scope "/api", PokemonCardsWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:pokemon_cards, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PokemonCardsWeb.Telemetry
